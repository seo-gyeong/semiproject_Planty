 ...
 <header class="menu1"> 
        ...
        <div class="nav-bar">
            ...
            <div class="navbar-right">
 			  ...
 			  <li><a href="${ pageContext.servletContext.contextPath }/login/login"> <img class="icon" src="${ pageContext.servletContext.contextPath }/resources/img/my.png"></a></li>
              <li><a href="${ pageContext.servletContext.contextPath }/login/login"> <img class="icon"  src="${ pageContext.servletContext.contextPath }/resources/img/cart.png"></a></li>
               </c:if>
               <c:if test="${ !empty sessionScope.loginMember }">
			  <li><a href="${ pageContext.servletContext.contextPath }/mypage"> <img class="icon" src="${ pageContext.servletContext.contextPath }/resources/img/my.png"></a></li>
              <li><a href="${ pageContext.servletContext.contextPath }/cart"> <img class="icon"  src="${ pageContext.servletContext.contextPath }/resources/img/cart.png"></a></li>
               </c:if>
		...
		<form class="login-input-section-wrap">
            ...
            <div class="type" >
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenu">
                  <li><button class="dropdown-item" style="font-size: 12px; color:#4C5B5D; " type="button" onclick="location.href='find id-member.html'">개인회원</button></li>
                  <li><button class="dropdown-item" style="font-size: 12px; color:#4C5B5D; " type="button" onclick="location.href='find id-partner.html'">법인사업자 회원</button></li>
                </ul>
              </div>
            </div>
           <div class="type1">
