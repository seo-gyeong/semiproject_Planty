...
<body>
    ...
    <div class="my-page wrapper">
        <div class="order-status">
            <h3 id="title">나의 주문 처리 현황</h3><br>
            <div class="container">
                <div class="item item1">입금전<br>
                    <div class="order-num">0</div>
                </div>
                <div class="item item2">배송준비중<br>
                    <div class="order-num">0</div>
                </div>
                <div class="item item3">배송중<br>
                    <div class="order-num">0</div>
                </div>
                <div class="item item4">배송완료<br>
                    <div class="order-num">0</div>
                </div>
            </div>
            <br>
        ...
        <form>
            <div class="intro-menu">
                ...
                <button class="int-menu int1" type="submit" formaction="${ pageContext.servletContext.contextPath }/mypage/order">
                    <div id="int-title">ORDER</div>
                    <div id="int-subtt">주문 조회</div>
                </button>
                <button class="int-menu int2" type="submit" formaction="${ pageContext.servletContext.contextPath }/mypage/wish">
                    <div id="int-title">WISH LIST</div>
                    <div id="int-subtt">찜하기 조회</div>
                </button>
                <button class="int-menu int3" type="submit" formaction="${ pageContext.servletContext.contextPath }/user/modify">
                    <div id="int-title">PROFILE</div>
                    <div id="int-subtt">회원정보 조회</div>
                </button>
                <button class="int-menu int4" type="submit" formaction="${ pageContext.servletContext.contextPath }/mypage/qna">
                ...
                <button class="int-menu int6" type="submit" formaction="${ pageContext.servletContext.contextPath }/mypage/coupon">
        ...
        <div class="quickmenu">
            <ul>
              ...
              <li><a href="${ pageContext.servletContext.contextPath }/mypage/review">리뷰조회</a></li>
