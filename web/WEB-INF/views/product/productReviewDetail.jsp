			...
			<div class="card shadow">
				<div class="card-body">
					...
					<div class="form-group">
						...
						<input type="text" id="board_date" name="board_date" class="form-control" value="${review.date }" disabled="disabled"/>
					</div>
					<div class="form-group">
						<label for="board_subject">제목</label>
						<input type="text" id="board_subject" name="board_subject" class="form-control" value="${review.title }" disabled="disabled"/>
					</div>
					<div class="form-group">
						<label for="board_content">내용</label>
						<textarea id="board_content" name="board_content" class="form-control" rows="10" style="resize:none" disabled="disabled">${review.content }</textarea>
					</div>
