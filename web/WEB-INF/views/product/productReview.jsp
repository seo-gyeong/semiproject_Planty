...
<body>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td onclick="reviewDetailView(${ review.reviewNo }, ${ product.pro_no });"> ${review.title }</td>
            <td class="table-td">${review.member.name }</td>
          </tr>
		  </c:forEach>
        </tbody>
      </table>
    ...
    <script>
			...
			function reviewDetailView(reviewNo, pro_no){
				location.href = '${ pageContext.servletContext.contextPath }/product/reviewDetail?reviewNo=' + reviewNo +'&pro_no=' + pro_no;
			}
	</script>
