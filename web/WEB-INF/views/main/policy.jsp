...
<body>
  ...
  <main>
    ...
    <div class="topic">
      <div class="open">
        <h2 class="question">이용약관</h2>
      </div>
      <p class="answer">
        **제1조(목적)**

        이 약관은 Planty 회사(전자상거래 사업자)가 운영하는 Planty 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.

        ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」

        **제2조(정의)**

        ① “몰”이란 Planty **회사**가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
        ...
        **제3조 (약관 등의 명시와 설명 및 개정)**
        ...
        ① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 Planty ****몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
        ...
        **제9조(구매신청 및 개인정보 제공 동의 등)**
        ...
        ② “몰”이 제3자에게 구매자 개인정보를 제공할 필요가 있는 경우 1) 개인정보를 제공받는 자, 2)개인정보를 제공받는 자의 개인정보 이용목적, 3) 제공하는 개인정보의 항목, 4) 개인정보를 제공받는자의 개인정보 보유 및 이용기간을 구매자에게 알리고 동의를 받아야 합니다. (동의를 받은 사항이 변경되는 경우에도 같습니다.)

        ③ “몰”이 제3자에게 구매자의 개인정보를 취급할 수 있도록 업무를 위탁하는 경우에는 1) 개인정보 취급위탁을 받는 자, 2) 개인정보 취급위탁을 하는 업무의 내용을 구매자에게 알리고 동의를 받아야 합니다. (동의를 받은 사항이 변경되는 경우에도 같습니다.) 다만, 서비스제공에 관한 계약이행을 위해 필요하고 구매자의 편의증진과 관련된 경우에는 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」에서
        ...
        **제22조(저작권의 귀속 및 이용제한)**
        ...
        ③ 이용자가 직접 작성 및 등록한 평가점수, 리뷰, 답글, 사진 등의 게시물(이용자 콘텐츠)에 대한 저작권 및 지적 재산권은 해당 이용자에게 있으며, 이용자는 “몰”에 해당 이용자 콘텐츠를 무상으로 이용할 수 있는 권리를 부여합니다. 이용자가 공개적으로 작성 및 공유한 콘텐츠(예: 상품 리뷰)의 경우 “몰”은 제품의 홍보를 위해 상점 내에 이용자의 콘텐츠를 재가공하여 영구적으로 인용할 수 있습니다.
        ...
        **제24조(재판권 및 준거법)**
        ...
        부 칙(시행일) 이 약관은 **2xxx년 x월 xx일**부터 시행합니다.
      </p>
    </div>

    <div class="topic">
      <div class="open">
        <h2 class="question">개인정보처리방침</h2>
      </div>
      <p class="answer">
        Planty는 (이하 '회사'는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.
        ...
        **■ 수집하는 개인정보 항목**
        ...
        ο 수집항목 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 비밀번호 질문과 답변 , 자택 전화번호 , 자택 주소 , 휴대전화번호 , 이메일 , 직업 , 회사명 , 부서 , 직책 , 회사전화번호 , 취미 , 결혼여부 , 기념일 , 법정대리인정보 , 주민등록번호 , 서비스 이용기록 , 접속 로그 , 접속 IP 정보 , 결제기록 , 개인통관고유부호
        ...
        **■ 개인정보의 수집 및 이용목적**
        ...
        1. 사이트 회원 가입 및 관리 : 회원가입시 본인여부 확인,서비스 이용 및 상담,공지사항 전달 , SNS 및 제 3자 계정을 연계하여 간편로그인 서비스 제공
        ...
        **■ 제3자에 대한 제공 및 수집한 개인정보의 위탁**
        ...
        상기사항에 의해 개인정보를 제공하는 경우에도 본래의 수집∙이용 목적에 반하여 무분별하게 정보가 제공되지 않도록 최대한 노력하겠으며 보다 나은 서비스 제공, 고객편의 제공 등 원활한 업무 수행을 위하여 아래와 같이 개인정보 처리 업무를 외부 전문업체에 위탁하여 운영하고 있습니다.

        - 위탁업무 내용 및 수탁자
        - 전산 시스템 구축 및 유지: (주)Planty
        - 카카오알림톡/문자메시지 발송: (주)Planty
        - 채널톡 마케팅 메시지 발송: (주) 조이코퍼레이션
        - 본인확인 : NHN KCP
        - 상품 배송추적: (주)Planty
        - 주문 상품의 배송: 택배사 이름을 작성하세요.
        - 결제 및 에스크로 서비스: pg 사 이름을 작성하세요.
