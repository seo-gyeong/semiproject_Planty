...
<body>
    ...
    <div class="join-form wrapper">
        <div id="join-form-align">
            <form id="join-form" method="POST" action="${ pageContext.servletContext.contextPath }/user/regist">
                <!-- 약관 동의 -->
                <ul class="terms-chk-all">
                ...
                <ul class="terms_bx_list">
                    <li class="terms_bx">
                        ...
                        <div class="terms_box" tabindex="0" id="divService">
                            <!-- 플랜티몰 이용약관 동의 -->
                            <div class="article" style="overflow-y:scroll;">
                                <p class="article_text">
                                    제1조(목적)<br>
                                    이 약관은 Planty 회사(전자상거래 사업자)가 운영하는 Planty 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라
                                    한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.<br>
                                    ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.
                                    <br><br>
                                    제2조(정의)<br>
                                    ① “몰”이란 Planty 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을
                                    ...
                                    전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 Planty몰의
                                    ...
                                    공지합니다. 다만, 이용자에게 불리하게 약관내용을 변경하는 경우에는 최소한 30일 이상의 사전 유예기간을 두고 공지합니다.이 경우 "몰“은 개정 전
                                    ...
                                    5. 만 19세 미만 미성년자가 이용계약을 하려면 반드시 이용계약에 관한 법정대리인(부모)의 동의를 받아야하며, 법정대리인의 이용계약에 관한 동의
                                    의사표시는 몰에서 정한 필요 서류를 이메일로 몰의 고객센터에 제출하는 것으로 확인합니다. 만약, 만 19세 미성년자인 회원이 법정대리인의 동의 없이
                                    허위로 계약하는 경우 본인 또는 법정대리인이 이를 취소할 수 있습니다.
                                    ...
                                    ① “몰”이용자는 “몰”상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, “몰”은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기
                                    쉽게 제공하여야 합니다.
                                    1. 재화 등의 검색 및 선택
                                    ...
                                    6. 결제방법의 선택
                                    ② “몰”이 제3자에게 구매자 개인정보를 제공할 필요가 있는 경우 1) 개인정보를 제공받는 자, 2)개인정보를 제공받는 자의 개인정보 이용목적, 3)
                                    제공하는 개인정보의 항목, 4) 개인정보를 제공받는 자의 개인정보 보유 및 이용기간을 구매자에게 알리고 동의를 받아야 합니다. (동의를 받은 사항이
                                    변경되는 경우에도 같습니다.)
                                    ③ “몰”이 제3자에게 구매자의 개인정보를 취급할 수 있도록 업무를 위탁하는 경우에는 1) 개인정보 취급위탁을 받는 자, 2) 개인정보 취급위탁을 하는
                                    업무의 내용을 구매자에게 알리고 동의를 받아야 합니다. (동의를 받은 사항이 변경되는 경우에도 같습니다.) 다만, 서비스제공에 관한 계약이행을 위해
                                    필요하고 구매자의 편의증진과 관련된 경우에는 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」에서 정하고 있는 방법으로 개인정보 취급방침을 통해
                                    알림으로써 고지절차와 동의절차를 거치지 않아도 됩니다.
                                    ④ “몰”이 호스팅을 변경하여 이전 할 경우 1년 동안 로그인하지 않은 휴면회원을 포함한 모든 "이용자"의 정보를 호스팅사에서 제공받아 이전하는
                                    호스팅사에 고객의 정보를 등록하고 "몰"의 서비스 연속성 관리를 위한 용도로 사용할 수 있습니다.
                                    <br><br>
                                    제10조 (계약의 성립)
                                    ...
                                    재화 등의 대금에 어떠한 명목의 수수료도추가하여 징수할 수 없습니다.
                                    ...
                                    <br><br>
                                    제14조(환급)
                                    “몰”은 이용자가 구매신청한 재화 등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체 없이 그 사유를 이용자에게 통지하고 사전에 재화
                                    ...
                                    ⑤ “몰”이 제2항과 제3항에 의해 이용자의 동의를 받아야 하는 경우에는 개인정보관리 책임자의 신원(소속, 성명 및 전화번호, 기타 연락처), 정보의
                                    ...
                                    ⑦ “몰”은 개인정보 보호를 위하여 이용자의 개인정보를 취급하는 자를최소한으로 제한하여야 하며 신용카드, 은행계좌 등을 포함한 이용자의 개인정보의
                                    분실, 도난, 유출, 동의 없는 제3자 제공, 변조 등으로 인한 이용자의 손해에 대하여 모든 책임을 집니다.
                                    ⑧ “몰” 또는 그로부터 개인정보를 제공받은 제3자는 개인정보의 수집목적 또는 제공받은 목적을 달성한 때에는 당해 개인정보를 지체 없이 파기합니다.
                                    ⑨ “몰”은 개인정보의 수집·이용·제공에 관한 동의 란을 미리 선택한 것으로 설정해두지 않습니다. 또한 개인정보의 수집·이용·제공에 관한 이용자의
                                    ...
                                    ③ 이용자가 직접 작성 및 등록한 평가점수, 리뷰, 답글, 사진 등의 게시물(이용자 콘텐츠)에 대한 저작권 및 지적 재산권은 해당 이용자에게 있으며,
                                    이용자는 “몰”에 해당 이용자 콘텐츠를 무상으로 이용할 수 있는 권리를 부여합니다. 이용자가 공개적으로 작성 및 공유한 콘텐츠(예: 상품 리뷰)의 경우
                                    “몰”은 제품의 홍보를 위해 상점 내에 이용자의 콘텐츠를 재가공하여 영구적으로 인용할 수 있습니다.
                                    <br><br>
                                    제23조(분쟁해결)
                                    ...
                                    <br><br>
                                    제24조(재판권 및 준거법)
                                    ① “몰”과 이용자 간에 발생한 전자상거래 분쟁에 관한 소송은 제소 당시의 이용자의 주소에 의하고, 주소가 없는 경우에는 거소를 관할하는 지방법원의
                                    전속관할로 합니다. 다만, 제소 당시 이용자의 주소 또는 거소가 분명하지 않거나 외국 거주자의 경우에는 민사소송법상의 관할법원에 제기합니다.
                                    ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
                                    부 칙(시행일) 이 약관은 2022년 4월 1일부터 시행합니다.
                                    <br>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="terms_box" tabindex="0" id="divService">
                            ...
                            <div class="article" style="overflow-y:scroll;">
                                <p class="article_text">
                                    ...
                                    <br>
                                    2. 수집하는 개인정보 항목<br>
                                    &nbsp;&nbsp; 아이디, 비밀번호, 주소, 연락처, 이메일주소, 마케팅 정보 수신 동의 항목을 필수 및 선택 항목으로 수집합니다.
                                    <br>
                                    3. 개인정보의 보유기간 및 이용기간<br>
                                    &nbsp;&nbsp; 원칙적으로, 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다.<br>
                                    &nbsp;&nbsp; 단, 다음의 정보에 대해서는 아래의 이유로 명시한 기간 동안 보존합니다.<br><br>
    
                                    - 회사 내부 방침에 의한 정보 보유 사유 · 부정거래 방지 및 쇼핑몰 운영방침에 따른 보관: 5년<br>
                                    - 관련 법령에 의한 정보보유 사유<br><br>
    
                                    가. 계약 또는 청약철회 등에 관한 기록
                                    - 보존이유: 전자상거래 등에서의 소비자 보호에 관한 법률<br>
                                    - 보존기간: 5년<br>
                                    <br>
                                    ...
                                    - 보존기간: 3개월<br>
                                    <br>
                                    ※ 동의를 거부할 수 있으나 거부 시 쇼핑몰 회원 서비스 이용이 불가능합니다.
                                </p>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="terms_bx">
                        ...
                        <div class="terms_box" tabindex="0" id="divService">
                            <!-- 쇼핑 정보 수신 동의 -->
                            <div class="article" style="overflow-y:scroll;">
                                <p class="article_text text-yn-txt">
                                    할인쿠폰 및 혜택, 이벤트, 신상품 소식 등 쇼핑몰에서 제공하는 유익한 쇼핑정보를 SMS나 이메일로 받아보실 수 있습니다.<br><br>
    ...
    <!-- jquery -->
    	...
    	<!-- check시 Y unchecked N 제출 -->
    	if(document.getElementById("textYn").checked) {
    	    document.getElementById("textYn-hidden").disabled = true;
    	}
